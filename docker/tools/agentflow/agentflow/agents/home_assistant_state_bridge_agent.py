...
class HomeAssistantStateBridgeAgent(Actor):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.ha_token = (
            os.getenv("HOME_ASSISTANT_TOKEN") or CONFIG.ha_token or ""
        ).strip()
        ...
        _raw_domains = (
            os.getenv("HA_STATE_BRIDGE_DOMAINS") or CONFIG.ha_state_bridge_domains or ""
        )
    ...
    def _current_task_description(self) -> str:
        ...
        domains = (
            ", ".join(sorted(self._domain_filter)) if self._domain_filter else "all"
        )
